...
namespace jettnet.mirage.bitpacking
{
    ...
    public static class PackedExtensions
    {
        ...
        public static void WritePackedInt32(this JettWriter writer, int i)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void WritePackedUInt32(this JettWriter writer, uint value)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void WritePackedInt64(this JettWriter writer, long i)
        {
            ulong zigzagged = ZigZag.Encode(i);
            writer.WritePackedUInt64(zigzagged);
        }

        public static void WritePackedUInt64(this JettWriter writer, ulong value)
        {
        ...
        public static int ReadPackedInt32(this JettReader reader)
        {
        ...
        public static uint ReadPackedUInt32(this JettReader reader) => checked((uint)reader.ReadPackedUInt64());

        public static long ReadPackedInt64(this JettReader reader)
        {
            ulong data = reader.ReadPackedUInt64();
            return ZigZag.Decode(data);
        }

        public static ulong ReadPackedUInt64(this JettReader reader)
        {
